...
1. From the dependencies folder install the pycharm software and python.
2. Install the mentioned Libraries via pycharm.

Run the code:
1. Open and run the WebScrapeThreads.py file given in the "Code" folder via pycharm. This will download the reviews in a text file.
2. Open and run the polarity.py file or polarity_english(location).py file based on what reviews who have downloaded. This will divide the reviews into good and bad, based on their ratings and polarity.
3. Open and run the partOfSpeechTagging.py to remove the extra words from the reviews.
